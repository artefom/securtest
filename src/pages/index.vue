      ...
      <div class="default-border questionarie-body">
        ...
        >
          <p class="question-body" style="flex-grow: 1">
            ...
            >
            , в котором мы собрали инструкции по организации и проведению
            некоторых оффлайн-ивентов. Если вы попали сюда из другого места и не
            читали этот документ, обязательно с ним ознакомьтесь, это поможет
            корректному восприятию теста!
          </p>
        ...
        <div class="results-body" style="">
          ...
          <div class="results-scroller">
            ...
            <div class="disclaimer">
              ...
              провести индивидуальные анонимные созвоны для разбора конкретно
              вашего кейса.
            </div>
...
let questions = [
  ...
  },
  {
    question:
      "Были ли уже случаи задержаний\\арестов на подобных мероприятиях,\
       даже если формально они законные (как тот случай, когда работников \
  ...
  },
  {
    question:
      ...
      и привлекающей внимание полиции (феминизм, квир- или антивоенный \
      активизм итп)? Если вы собрались делать что-то \
      совсем безобидное, вроде пикника, воркшопа по вязанию \
      или просмотра мультика — смело тыкайте 'нет' ",
    answer: null,
    answer_display: null,
  },
];
